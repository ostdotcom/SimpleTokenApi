...
module GlobalConstant
  ...
  class ClientTemplate
    ...
    class << self
      ...
      # client cloudfront url - "d27ixhmpjdysfk.cloudfront.net"
      ...
      def common
        {
            ...
            background_gradient_style: '.bg-gradient {background: linear-gradient(to bottom, #f3f9f4 0%, #ffffff 135px, #ffffff 100%)}',
            header: {
                logo: {
                    href: '/',
            ...
            footer_html: '<footer style="width: 100%;position: absolute;font-size:14px;font-weight: 300;letter-spacing: 1.3px;text-align:center;padding:20px 10px;color:#9ea9a7;background:#e5efe8;">Copyright &copy; 2017 Simple Token. All Rights Reserved. <a href="https://simpletoken.org/privacy" title="Privacy Policy" target="_blank" style="color: #9ea9a7;text-decoration: none;border-bottom: 1px solid #9ea9a7;" rel="nofollow">Privacy Policy</a>, <a href="https://simpletoken.org/terms" title="Website Terms" target="_blank" style="color: #9ea9a7;text-decoration: none;border-bottom: 1px solid #9ea9a7;" rel="nofollow">Website Terms</a> and <a href="https://drive.google.com/file/d/0B1E_xJPbELBKeU9pUk5uSnNqWFU/view" title="OST Token Terms" target="_blank" style="color: #9ea9a7;text-decoration: none;border-bottom: 1px solid #9ea9a7;" rel="nofollow">OST Token Terms</a> </footer>',
      ...
      def sign_up
        {
            checkbox_html: 'By checking this box, you agree to our <a href="https://simpletoken.org/terms" title="Terms of Service" target="_blank" rel="nofollow">Terms of Service</a> and acknowledge and consent to our <a href="https://simpletoken.org/privacy" title="Privacy Policy" target="_blank">Privacy Policy</a>.'
        }
      end
      ...
      def kyc
        {
            ...
            verify_modal: {
                add_kyc_checkbox_points_html: [
                    ...
                    'I have read, understood and agree to <a href="<%= GlobalConstant::Base.simple_token_web["root_url"] %>/privacy" target="_blank" class="modal-ext-link" rel="nofollow">OpenST Limited"s Privacy Policy</a>. I acknowledge this may change. I also understand that any purchase of Simple Tokens will be subject to additional terms and conditions.',
