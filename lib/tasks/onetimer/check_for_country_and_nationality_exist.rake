namespace :onetimer do
  ...
  task :check_for_country_and_nationality_exist => :environment do
    ...
    country_array.each do |country|
      ...
      countries_present_in_db << country if user_extended_detail_ids.present?
    end
    puts countries_present_in_db

    nationality_array.each do |nationality|

      hashed_db_nationality = Md5UserExtendedDetail.get_hashed_value("INDIAN1")
      ...
      nationality_present_in_db << nationality if user_extended_detail_ids.present?
    end
