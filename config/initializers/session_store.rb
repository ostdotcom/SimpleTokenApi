...
Rails.application.config.middleware.use ActionDispatch::Session::CookieStore, key: '_ost_session_id', http_only: true, secure: !Rails.env.development?, same_site: :strict
