class ModifyPreSalePurchaseLog < DbMigrationConnection
  ...
  def up
    run_migration_for_db(EstablishSimpleTokenContractInteractionsDbConnection.config_key) do
      ...
      add_column :pre_sale_purchase_logs, :st_base_token, :decimal, precision: 30, null: false, after: :ethereum_address
      add_column :pre_sale_purchase_logs, :st_bonus_token, :decimal, precision: 30, after: :st_base_token
